...
export type Relationship={id:string;fromCharacterId:string;toCharacterId:string;type:string;description?:string;createdAt:string;updatedAt:string};
export type MoodboardItem={id:string;title:string;imageUrl:string;createdAt:string;updatedAt:string};
export type Project={id:string;title:string;type:ProjectType;genre:Genre;status:ProjectStatus;description?:string;coverUrl?:string;progress?:number;characters:Character[];worldbuilding:GenericItem[];chapters:Chapter[];scenes:Scene[];relationships:Relationship[];plotTwists:GenericItem[];randomIdeas:Idea[];writingDocuments:WritingDocument[];bookStructure:BookStructure;moodboard:MoodboardItem[];customSections:GenericItem[];createdAt:string;updatedAt:string};
